...
contract ChainTorqueMarketplace is ERC721URIStorage, ReentrancyGuard, Ownable {
    ...
    function createToken(
        ...
        createMarketItem(newTokenId, price, category, title, description);
        return newTokenId;
    }
    ...
    function getMarketplaceStats() public view returns (uint256, uint256, uint256) {
        return (_tokenIds.current(), _itemsSold.current(), listingPrice);
    }
